...
from src.models.predictive_modeling_nn import GradePredictorNN
...
def main():
    try:
        ...
        # Step 4: Grade Prediction (Neural Network)
        logger.info("Starting grade prediction modeling (Neural Network)...")
        predictor = GradePredictorNN()
        ...
        # Save the model
        predictor.save_model("models/grade_predictor_nn.pkl")
        ...
        importance_df.to_csv("models/feature_importance_nn.csv", index=False)
        
        # Step 5: Visualization
        logger.info("Creating visualizations...")
        visualizer = DataVisualizer(output_dir="visualizations_nn")
        ...
        logger.info("Analysis pipeline (Neural Network) completed successfully!")
